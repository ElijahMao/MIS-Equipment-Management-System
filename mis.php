                ...
                <div class="container">
                    <div class="col-md-8 col-lg-7 col-sm-12 col-xs-12">
                        <div class="welcome-text">
							...
							<div>
								<table style="color:black; background-color:white; border:3px #31dc89 outset; font-size:16px;"  border='10' align="center" width="180%">
									<tr style="background-color:#66FF66">
										<td align="center" colspan="4">筆記型電腦區</td>
									</tr>
									<tr style="background-color:#99FF99">
										<td align="center">設備編號</td>
...
?>
									<tr bgcolor="gray">
										<td align="center"><font color="white"><?php echo $rs[0]?></font></td>
...
?>
									<tr style="background-color:#66FF66">
										<td align="center"  colspan="4">數位相機區</td>
									</tr>
									<tr style="background-color:#99FF99">
										<td align="center" >設備編號</td>
										<td align="center">設備狀態</td>
...
?>									
									<tr style="background-color:#66FF66">
										<td align="center"  colspan="5">儲存設備區</td>
									</tr>
									<tr style="background-color:#99FF99">
										<td align="center" >設備編號</td>
										<td align="center">設備狀態</td>
...
?>
									<tr bgcolor="gray">
										<td align="center" ><font color="white"><?php echo $rs[0]?></td>
